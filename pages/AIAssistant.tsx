...
const AIAssistant: React.FC = () => {
    ...
    return (
        <div className="max-w-7xl mx-auto flex flex-col h-full w-full p-4 md:p-6 gap-6">
            {/* Header */}
            <header className="flex flex-col gap-2 shrink-0">
                <div className="flex items-center gap-3">
                    <div className="w-12 h-12 rounded-full bg-gradient-to-br from-primary to-primary-hover dark:from-gold dark:to-gold-light flex items-center justify-center">
                        <span className="material-symbols-outlined text-white text-2xl">smart_toy</span>
                    </div>
                    <div>
                        <h1 className="text-3xl font-bold tracking-tight">Assistente IA</h1>
                        <p className="text-text-muted dark:text-text-dark-muted text-sm flex items-center gap-1">
            ...
            {/* Chat Area */}
            <div className="flex-1 bg-surface-light dark:bg-surface-dark border border-border-light dark:border-border-dark rounded-xl overflow-hidden flex flex-col min-h-0">
                {/* Messages */}
